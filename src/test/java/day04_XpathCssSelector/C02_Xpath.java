...
public class C02_Xpath {
    public static void main(String[] args) {
        ...
        if (deleteButonu.isDisplayed()){
            ...
            System.out.println("delete butonu gorunuyor testi FAİLED");
        }
        ...
        WebElement addYazisiElementi2=driver.findElement(By.tagName("h3")); // tagname de sadece h3 yazmak yeterlı
