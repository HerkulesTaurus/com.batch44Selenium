...
public class C06_ManageWindow {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Fullscren durumunda position :"+driver.manage().window().getPosition());
        System.out.println("Fullscren durumunda size :"+driver.manage().window().getSize());
        //9. Sayfayi kapatin
        driver.close();
    }
}
